...
public class FileWatcher implements Runnable {
    ...
    public FileWatcher(ArrayDeque<String> fileNames, PropertiesProvider propertiesProvider) {
    ...
    public void startWatcher() {
        try (WatchService watcher = FileSystems.getDefault().newWatchService()) {
            ...
            while (true) {
                ...
                if (fileNames.size() == maxFileQueueSize) {
    ...
    public void run() {
        ...
        fileWatcher = new FileWatcher(fileNames, propertiesProvider);
